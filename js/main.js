...
$(function() {
	if ($("#github_path").length > 0) {
		
		var github_path = $("#github_path").val();
		$("#getclone-url-btn").attr("data-clipboard-text", "https://github.com/" + github_path + ".git");
		
		var client = new ZeroClipboard( document.getElementById("getclone-url-btn"), {
		...
		$(".getcode-btn").click(function() {
			...
			var url = "";
			switch($btn.attr("data-protocol")) {
				case "https":
					url = "https://github.com/" + github_path + ".git";
					break;
				case "ssh":
					url = "git@github.com:" + github_path + ".git";
					break;
				case "subversion":
			...
			$("#getclone-url").val(url);
			$("#getclone-url-btn").attr("data-clipboard-text", url);
